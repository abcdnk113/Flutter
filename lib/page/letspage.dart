          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text("Let's See",style: GoogleFonts.poppins(
                    fontSize: 42.16,fontWeight: FontWeight.w700,color:const Color.fromRGBO(12, 18, 26, 1)
                  )
                  ),         
                  Row(
                    ...
                    fontSize: 42.16,fontWeight: FontWeight.w700
                      ...
                      ImageGradient(image: Image.asset('images/icons/star.png',width: 36,height: 39,), gradient: const LinearGradient(colors:[Colors.white,Colors.yellow],begin: Alignment.topCenter,end: Alignment.bottomCenter))                 
                    ],
                  ),
